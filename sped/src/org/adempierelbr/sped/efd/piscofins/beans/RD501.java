 ...
 * @version $Id: RD501.java, 21/02/2011, 12:39:00, mgrigioni
 */
public class RD501 extends RegSped implements Comparable<Object>{	
	 ...
	 * @param COD_CTA
	 */
	public RD501(String CST_PIS, BigDecimal VL_ITEM, String NAT_BC_CRED, 
	...
	public void addValues(RD501 otherD501){
		this.VL_ITEM   = getVL_ITEM().add(otherD501.getVL_ITEM());
		this.VL_BC_PIS = getVL_BC_PIS().add(otherD501.getVL_BC_PIS());
		this.VL_PIS    = getVL_PIS().add(otherD501.getVL_PIS());
	}
