 ...
 */
public class RD505 extends RegSped implements Comparable<Object>{	
	 ...
	 * @param COD_CTA
	 */
	public RD505(String CST_COFINS, BigDecimal VL_ITEM, String NAT_BC_CRED, 
	...
	public void addValues(RD505 otherD505){
		this.VL_ITEM      = getVL_ITEM().add(otherD505.getVL_ITEM());
		this.VL_BC_COFINS = getVL_BC_COFINS().add(otherD505.getVL_BC_COFINS());
		this.VL_COFINS    = getVL_COFINS().add(otherD505.getVL_COFINS());
	}
