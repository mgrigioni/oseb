 ...
 *****************************************************************************/
package org.adempierelbr.sped.efd.contrib;
...
import org.adempierelbr.sped.efd.contrib.beans.R0000;
import org.adempierelbr.sped.efd.contrib.beans.R0100;
import org.adempierelbr.sped.efd.contrib.beans.R0110;
import org.adempierelbr.sped.efd.contrib.beans.R0111;
import org.adempierelbr.sped.efd.contrib.beans.R0140;
...
import org.adempierelbr.sped.efd.contrib.beans.RA010;
import org.adempierelbr.sped.efd.contrib.beans.RA100;
import org.adempierelbr.sped.efd.contrib.beans.RA170;
import org.adempierelbr.sped.efd.contrib.beans.RC010;
...
import org.adempierelbr.sped.efd.contrib.beans.RD010;
 ...
 */
public class EFDUtil_Contrib
{
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(EFDUtil_Contrib.class);
	...
	public static void setEnv(Properties ctx, String trx, int AD_Org_ID){
		EFDUtil_Contrib.AD_Org_ID = AD_Org_ID;
		EFDUtil_Contrib.ctx = ctx;
		EFDUtil_Contrib.trx = trx;
	}
