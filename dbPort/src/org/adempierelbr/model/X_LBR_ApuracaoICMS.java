...
/** Generated Model for LBR_ApuracaoICMS
 *  @author ADempiereLBR (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_LBR_ApuracaoICMS extends PO implements I_LBR_ApuracaoICMS, I_Persistent 
{
    ...
    public X_LBR_ApuracaoICMS (Properties ctx, int LBR_ApuracaoICMS_ID, String trxName)
    {
      super (ctx, LBR_ApuracaoICMS_ID, trxName);
      /** if (LBR_ApuracaoICMS_ID == 0)
        {
			setC_Period_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_LBR_ApuracaoICMS (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LBR_ApuracaoICMS[")
	...
	{
		throw new IllegalArgumentException ("CumulatedAmt is virtual column");	}
