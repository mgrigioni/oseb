...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NFDI ADD Manufacturer NVARCHAR2(60) DEFAULT NULL 
;

-- 24/09/2012 9h1min30s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (Created,IsActive,Name,Description,AD_Client_ID,UpdatedBy,AD_Column_ID,AD_Field_ID,Updated,DisplayLength,IsDisplayed,IsEncrypted,AD_Org_ID,EntityType,IsSameLine,IsHeading,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,Help,IsReadOnly,CreatedBy) VALUES (TO_DATE('2012-09-24 09:01:29','YYYY-MM-DD HH24:MI:SS'),'Y','Manufacturer','Manufacturer of the Product',0,100,1250023,1250364,TO_DATE('2012-09-24 09:01:29','YYYY-MM-DD HH24:MI:SS'),60,'Y','N',0,'LBRA','N','N',3000010,'N','Y','The manufacturer of the Product (used if different from the Business Partner / Vendor)','N',100)
;
