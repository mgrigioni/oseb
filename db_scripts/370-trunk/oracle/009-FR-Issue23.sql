...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NotaFiscal ADD ChargeAmt NUMBER DEFAULT NULL 
;

-- 14/08/2012 11h56min34s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (Created,IsActive,Name,Description,AD_Client_ID,UpdatedBy,AD_Column_ID,AD_Field_ID,Updated,DisplayLength,IsDisplayed,IsEncrypted,AD_Org_ID,EntityType,IsSameLine,IsHeading,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,Help,IsReadOnly,CreatedBy) VALUES (TO_DATE('2012-08-14 11:56:33','YYYY-MM-DD HH24:MI:SS'),'Y','Charge amount','Charge Amount',0,100,1250004,1250338,TO_DATE('2012-08-14 11:56:33','YYYY-MM-DD HH24:MI:SS'),22,'Y','N',0,'LBRA','N','N',1000020,'N','Y','The Charge Amount indicates the amount for an additional charge.','N',100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (Created,IsActive,Name,Description,AD_Client_ID,UpdatedBy,AD_Column_ID,AD_Field_ID,Updated,DisplayLength,IsDisplayed,IsEncrypted,AD_Org_ID,EntityType,IsSameLine,IsHeading,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,Help,IsReadOnly,CreatedBy) VALUES (TO_DATE('2012-08-14 12:00:08','YYYY-MM-DD HH24:MI:SS'),'Y','Charge amount','Charge Amount',0,100,1250004,1250344,TO_DATE('2012-08-14 12:00:08','YYYY-MM-DD HH24:MI:SS'),22,'Y','N',0,'LBRA','N','N',1000028,'N','Y','The Charge Amount indicates the amount for an additional charge.','N',100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET AD_FieldGroup_ID=103,Updated=TO_DATE('2012-08-14 12:00:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1250344
;

-- 14/08/2012 12h0min49s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET AD_FieldGroup_ID=103,Updated=TO_DATE('2012-08-14 12:00:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1250338
;
