...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Workflow SET AD_WF_Node_ID=1250000, IsValid='Y',Updated=TO_TIMESTAMP('2012-05-29 15:32:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Workflow_ID=1250000
;

-- 29/05/2012 16h20min3s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_WF_Node (CreatedBy,Updated,UpdatedBy,AD_WF_Node_ID,"action",EntityType,Created,AD_Workflow_ID,IsCentrallyMaintained,IsActive,Name,XPosition,AD_Client_ID,AD_Org_ID,WorkingTime,SplitElement,Duration,Value,WaitingTime,JoinElement,"limit",DocAction,YPosition,WaitTime,Priority,Cost,DynPriorityChange) VALUES (100,TO_TIMESTAMP('2012-05-29 16:20:01','YYYY-MM-DD HH24:MI:SS'),100,1250001,'D','LBRA',TO_TIMESTAMP('2012-05-29 16:20:01','YYYY-MM-DD HH24:MI:SS'),1250000,'Y','Y','(DocAuto)',0,0,0,0,'X',0,'(DocAuto)',0,'X',0,'--',0,0,0,0,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_WF_Node (CreatedBy,Updated,UpdatedBy,AD_WF_Node_ID,"action",EntityType,Created,AD_Workflow_ID,IsCentrallyMaintained,IsActive,Name,XPosition,AD_Client_ID,AD_Org_ID,WorkingTime,SplitElement,Duration,Value,WaitingTime,JoinElement,"limit",DocAction,YPosition,WaitTime,Priority,Cost,DynPriorityChange) VALUES (100,TO_TIMESTAMP('2012-05-29 16:24:12','YYYY-MM-DD HH24:MI:SS'),100,1250002,'D','LBRA',TO_TIMESTAMP('2012-05-29 16:24:12','YYYY-MM-DD HH24:MI:SS'),1250000,'Y','Y','(DocComplete)',0,0,0,0,'X',0,'(DocComplete)',0,'X',0,'--',0,0,0,0,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_WF_Node (CreatedBy,Updated,UpdatedBy,AD_WF_Node_ID,"action",EntityType,Created,AD_Workflow_ID,IsCentrallyMaintained,IsActive,Name,XPosition,AD_Client_ID,AD_Org_ID,WorkingTime,SplitElement,Duration,Value,WaitingTime,JoinElement,"limit",DocAction,YPosition,WaitTime,Priority,Cost,DynPriorityChange) VALUES (100,TO_TIMESTAMP('2012-05-29 16:25:16','YYYY-MM-DD HH24:MI:SS'),100,1250003,'D','LBRA',TO_TIMESTAMP('2012-05-29 16:25:16','YYYY-MM-DD HH24:MI:SS'),1250000,'Y','Y','(DocPrepare)',0,0,0,0,'X',0,'(DocPrepare)',0,'X',0,'PR',0,0,0,0,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (Created,IsActive,Name,Description,AD_Client_ID,UpdatedBy,AD_Column_ID,AD_Field_ID,Updated,DisplayLength,IsDisplayed,IsEncrypted,AD_Org_ID,EntityType,IsSameLine,IsHeading,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,Help,IsReadOnly,CreatedBy) VALUES (TO_TIMESTAMP('2012-05-30 10:07:22','YYYY-MM-DD HH24:MI:SS'),'Y','Document Action','The targeted status of the document',0,100,1250000,1250000,TO_TIMESTAMP('2012-05-30 10:07:22','YYYY-MM-DD HH24:MI:SS'),2,'Y','N',0,'LBRA','N','N',1100001,'N','Y','You find the current status in the Document Status field. The options are listed in a popup','N',100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (Created,IsActive,Name,Description,AD_Client_ID,UpdatedBy,AD_Column_ID,AD_Field_ID,Updated,DisplayLength,IsDisplayed,IsEncrypted,AD_Org_ID,EntityType,IsSameLine,IsHeading,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,Help,IsReadOnly,CreatedBy) VALUES (TO_TIMESTAMP('2012-05-30 10:07:24','YYYY-MM-DD HH24:MI:SS'),'Y','Document Status','The current status of the document',0,100,1250001,1250001,TO_TIMESTAMP('2012-05-30 10:07:24','YYYY-MM-DD HH24:MI:SS'),2,'Y','N',0,'LBRA','N','N',1100001,'N','Y','The Document Status indicates the status of a document at this time.  If you want to change the document status, use the Document Action field','N',100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2012-05-30 10:11:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1250000
;

-- 30/05/2012 10h11min46s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET DisplayLength=20, AD_FieldGroup_ID=1100001,Updated=TO_TIMESTAMP('2012-05-30 10:11:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100034
;

-- 30/05/2012 10h11min51s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET AD_FieldGroup_ID=1100001,Updated=TO_TIMESTAMP('2012-05-30 10:11:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100033
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET AD_FieldGroup_ID=1100001,Updated=TO_TIMESTAMP('2012-05-30 11:30:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100032
;

-- 30/05/2012 13h47min53s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_WF_NodeNext (AD_WF_Next_ID,EntityType,AD_Org_ID,AD_Client_ID,UpdatedBy,AD_WF_Node_ID,Created,IsActive,CreatedBy,Updated,IsStdUserWorkflow,SeqNo,AD_WF_NodeNext_ID) VALUES (1250001,'U',0,0,100,1250000,TO_TIMESTAMP('2012-05-30 13:47:51','YYYY-MM-DD HH24:MI:SS'),'Y',100,TO_TIMESTAMP('2012-05-30 13:47:51','YYYY-MM-DD HH24:MI:SS'),'N',10,1250001)
;

-- 30/05/2012 13h48min4s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_WF_NodeNext (AD_WF_Next_ID,EntityType,AD_Org_ID,AD_Client_ID,UpdatedBy,AD_WF_Node_ID,Created,IsActive,CreatedBy,Updated,IsStdUserWorkflow,SeqNo,AD_WF_NodeNext_ID) VALUES (1250003,'U',0,0,100,1250000,TO_TIMESTAMP('2012-05-30 13:48:03','YYYY-MM-DD HH24:MI:SS'),'Y',100,TO_TIMESTAMP('2012-05-30 13:48:03','YYYY-MM-DD HH24:MI:SS'),'N',10,1250002)
;

-- 30/05/2012 13h48min10s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_WF_Node SET XPosition=5, YPosition=5,Updated=TO_TIMESTAMP('2012-05-30 13:48:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=1250000
;

-- 30/05/2012 13h48min10s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_WF_Node SET XPosition=5, YPosition=105,Updated=TO_TIMESTAMP('2012-05-30 13:48:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=1250001
;

-- 30/05/2012 13h48min10s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_WF_Node SET XPosition=230, YPosition=105,Updated=TO_TIMESTAMP('2012-05-30 13:48:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=1250002
;

-- 30/05/2012 13h48min10s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_WF_Node SET XPosition=230, YPosition=5,Updated=TO_TIMESTAMP('2012-05-30 13:48:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=1250003
;

-- 30/05/2012 13h58min56s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET IsIdentifier='Y',Updated=TO_TIMESTAMP('2012-05-30 13:58:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1100068
;

-- 30/05/2012 14h9min25s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2012-05-30 14:09:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1250001
;

-- 30/05/2012 14h9min58s BRT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2012-05-30 14:09:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1100025
;
