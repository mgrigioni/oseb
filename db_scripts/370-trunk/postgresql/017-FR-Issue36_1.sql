...
UPDATE AD_Ref_List SET EntityType='LBRA',Updated=TO_TIMESTAMP('2013-01-17 11:26:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121320
;

-- 17/01/2013 11h26min26s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Ref_List SET EntityType='LBRA',Updated=TO_TIMESTAMP('2013-01-17 11:26:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121321
;

-- 17/01/2013 11h26min32s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Ref_List SET EntityType='LBRA',Updated=TO_TIMESTAMP('2013-01-17 11:26:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121322
;

-- 17/01/2013 11h26min35s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Ref_List SET EntityType='LBRA',Updated=TO_TIMESTAMP('2013-01-17 11:26:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121323
;

-- 17/01/2013 11h26min37s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Ref_List SET EntityType='LBRA',Updated=TO_TIMESTAMP('2013-01-17 11:26:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=1121324
;

-- 17/01/2013 11h27min0s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Column (IsMandatory,Description,AD_Table_ID,Version,AD_Reference_Value_ID,Help,AD_Client_ID,AD_Org_ID,IsActive,EntityType,Name,SeqNo,IsIdentifier,AD_Column_ID,AD_Element_ID,ColumnName,IsTranslated,Created,CreatedBy,Updated,IsParent,AD_Reference_ID,IsSyncDatabase,FieldLength,UpdatedBy,IsUpdateable,IsKey,IsSelectionColumn,IsAlwaysUpdateable,IsEncrypted,IsAutocomplete,IsAllowLogging) VALUES ('N','Defines the Product Source',1000028,0,1000031,'Defines the Product Source',0,0,'Y','LBRA','Product Source',0,'N',1250025,1000254,'lbr_ProductSource','N',TO_TIMESTAMP('2013-01-17 11:26:58','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-01-17 11:26:58','YYYY-MM-DD HH24:MI:SS'),'N',17,'N',1,100,'Y','N','N','N','N','N','Y')
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NotaFiscalLine ADD COLUMN lbr_ProductSource CHAR(1) DEFAULT NULL 
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (Created,IsActive,Name,AD_Client_ID,UpdatedBy,AD_Column_ID,AD_Field_ID,Updated,DisplayLength,IsDisplayed,IsEncrypted,AD_Org_ID,EntityType,IsSameLine,IsHeading,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,IsReadOnly,CreatedBy) VALUES (TO_TIMESTAMP('2013-01-17 11:50:31','YYYY-MM-DD HH24:MI:SS'),'Y','DE',0,100,1250024,1250371,TO_TIMESTAMP('2013-01-17 11:50:31','YYYY-MM-DD HH24:MI:SS'),22,'Y','N',0,'LBRA','N','N',1000021,'N','Y','N',100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (Created,IsActive,Name,Description,AD_Client_ID,UpdatedBy,AD_Column_ID,AD_Field_ID,Updated,DisplayLength,IsDisplayed,IsEncrypted,AD_Org_ID,EntityType,IsSameLine,IsHeading,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,Help,IsReadOnly,CreatedBy) VALUES (TO_TIMESTAMP('2013-01-17 11:50:32','YYYY-MM-DD HH24:MI:SS'),'Y','Product Source','Defines the Product Source',0,100,1250025,1250372,TO_TIMESTAMP('2013-01-17 11:50:32','YYYY-MM-DD HH24:MI:SS'),1,'Y','N',0,'LBRA','N','N',1000021,'N','Y','Defines the Product Source','N',100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Reference_Value_ID=1000029, AD_Reference_ID=17, FieldLength=2,Updated=TO_TIMESTAMP('2013-01-17 11:57:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000701
;

-- 17/01/2013 11h57min32s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO t_alter_column values('lbr_notafiscalline','lbr_TaxStatus','VARCHAR(2)',null,'NULL')
;

-- 17/01/2013 11h58min15s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Reference_Value_ID=1000029, AD_Reference_ID=17, FieldLength=2,Updated=TO_TIMESTAMP('2013-01-17 11:58:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000656
;

-- 17/01/2013 11h58min17s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO t_alter_column values('c_invoiceline','lbr_TaxStatus','VARCHAR(2)',null,'NULL')
;

-- 17/01/2013 11h58min45s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Reference_Value_ID=1000029, AD_Reference_ID=17, FieldLength=2,Updated=TO_TIMESTAMP('2013-01-17 11:58:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000654
;

-- 17/01/2013 11h58min46s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO t_alter_column values('c_orderline','lbr_TaxStatus','VARCHAR(2)',null,'NULL')
;
