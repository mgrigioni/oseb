...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE LBR_NotaFiscalLine ADD COLUMN LBR_DE_ID NUMERIC(10) DEFAULT NULL 
;

-- 18/12/2012 14h57min3s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Tab SET AD_Column_ID=NULL,Updated=TO_TIMESTAMP('2012-12-18 14:57:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000047
;

-- 18/12/2012 15h7min3s BRST
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Tab SET AD_Column_ID=1250024, AD_Table_ID=1000028,Updated=TO_TIMESTAMP('2012-12-18 15:07:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000047
;
...
update ad_tab set ad_column_id = null where ad_column_id = 1120211;
