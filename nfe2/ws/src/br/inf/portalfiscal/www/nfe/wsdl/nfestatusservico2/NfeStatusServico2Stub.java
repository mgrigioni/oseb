...
public class NfeStatusServico2Stub extends org.apache.axis2.client.Stub {
	...
	public static void setAmbiente(String ambiente, int C_Region_ID, boolean isSCAN) {
		stubAddress = isSCAN ?  MLBRNFeWebService.getSCANURL(MLBRNFeWebService.STATUSSERVICO,ambiente, "2.00")
			: MLBRNFeWebService.getURL(MLBRNFeWebService.STATUSSERVICO,ambiente, "2.00", C_Region_ID);
	}
