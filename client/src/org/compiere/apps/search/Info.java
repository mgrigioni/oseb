	...
	implements ListSelectionListener
{
		...
		boolean multiSelection, String whereClause)
	{
		...
		if (tableName.equals("C_BPartner"))
			...
			info = new InfoAssignment (frame, modal, WindowNo, value,
					multiSelection, whereClause);
		else if (tableName.equals("LBR_NotaFiscal")) //Nota Fiscal - Mario Grigioni
			info = new InfoNotaFiscal (frame, modal, WindowNo, value,
					multiSelection, whereClause);
		else
	...
	/**
	 * Show Nota Fiscal Info (non modal)
	 * @param frame Parent Frame
	 * @param WindowNo window no
	 * @param value query value
	 */
	public static void showNotaFiscal (Frame frame, int WindowNo, String value)
	{
		Info info = new InfoNotaFiscal (frame, false, WindowNo, value,
			false, "");
		AEnv.showCenterWindow(frame, info);
	}   //  showNotaFiscal
