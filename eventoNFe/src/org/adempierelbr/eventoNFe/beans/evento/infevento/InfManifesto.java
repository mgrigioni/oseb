...
/**
 * 	Informações de Manisfestação do Destinatário
 * 
 * 	@author Mario Grigioni
 *	@version $Id: InfManifesto.java, v1.0 01/04/2013 11:05, mgrigioni Exp $
 */
@XStreamAlias ("infEvento")
public class InfManifesto extends InfEvento {	
	
	public InfManifesto(String tpEvento){
