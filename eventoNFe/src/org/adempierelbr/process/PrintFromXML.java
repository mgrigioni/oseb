...
public class PrintFromXML extends SvrProcess
{
	...
	protected String doIt() throws JRException, AdempiereException, IOException 
	{
		...
		if (getProcessInfo().getTable_ID() == MLBREventoNFe.Table_ID)
		{
			MLBREventoNFe cce = new MLBREventoNFe (Env.getCtx(), p_Record_ID, null);
			
			if (!cce.getEventType().equals(X_LBR_EventoNFe.EVENTTYPE_CartaDeCorreção))
				return "Tipo de evento n\u00E3o dispon\u00EDvel para impress\u00E3o";
